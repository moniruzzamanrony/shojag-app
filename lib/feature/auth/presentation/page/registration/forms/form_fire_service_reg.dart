...
class FormFireServiceReg extends StatefulWidget {
  const FormFireServiceReg({super.key});

  @override
  State<FormFireServiceReg> createState() => _FormFireServiceRegState();
}

class _FormFireServiceRegState extends State<FormFireServiceReg> {
      ...
      child: Column(
        children: [
          ...
          RegOrganizationWidget(
            ...
            hintText: context.language.fireStation,
