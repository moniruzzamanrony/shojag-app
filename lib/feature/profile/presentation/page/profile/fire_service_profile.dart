...
class FireServiceProfile extends StatelessWidget {
  final UserFireService user;
  const FireServiceProfile({super.key, required this.user});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        ProfileHeaderWidget(title: context.language.fireStation),
        headerContentSeparator(),
        ProfileContentWidget(text: user.fireStation),
        itemSeparator(),
