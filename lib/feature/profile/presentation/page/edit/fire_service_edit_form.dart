...
class FireServiceEditForm extends StatefulWidget {
  final UserFireService currentUser;

  const FireServiceEditForm({super.key, required this.currentUser});

  @override
  State<FireServiceEditForm> createState() => _FireServiceEditFormState();
}

class _FireServiceEditFormState extends State<FireServiceEditForm> {
      ...
      child: Column(children: [
        ...
        LoadingAnimatedButton(
            ...
            onTap: (startLoading, stopLoading, btnState) =>
                _updateFireServiceProfile(context,
  ...
  void _updateFireServiceProfile(BuildContext ctx,
