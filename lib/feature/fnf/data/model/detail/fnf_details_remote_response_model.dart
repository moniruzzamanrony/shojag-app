class FnfDetailsRemoteResponseModel {
  FnfDetailsRemoteResponseModel({
    this.success,
    this.message,
    this.data,
  });

  FnfDetailsRemoteResponseModel.fromJson(dynamic json) {
  ...
  FnfDetailsRemoteResponseModel copyWith({
    bool? success,
    String? message,
    Data? data,
  }) =>
