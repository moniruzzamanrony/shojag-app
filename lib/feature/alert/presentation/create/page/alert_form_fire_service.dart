...
import '../widget/incident_search_widget.dart';
import '../widget/mandatory_widget.dart';

/// UI [AlertFormFireService] for fire service alert
class AlertFormFireService extends StatelessWidget {
  const AlertFormFireService({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        _itemGap20(),
        //const ShareAlsoWidget(currentType: AlertType.fireService),
        const AlertAddButtonWidget(currentType: AlertType.fireService),
