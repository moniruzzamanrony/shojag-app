...
/// UI [AlertFormAmbulance] for ambulance alert
class AlertFormAmbulance extends StatelessWidget {
  const AlertFormAmbulance({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        _itemGap20(),
        const AlertAddButtonWidget(currentType: AlertType.ambulance),
